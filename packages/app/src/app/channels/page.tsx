        ...
        {loading ? (
          <div className="space-y-4 animate-fade-in">
            <div className="text-center py-8 text-slate-400">
              <div className="skeleton h-8 w-48 mx-auto rounded mb-4"></div>
              <p className="text-sm">Carregando seus canais do YouTube...</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[1, 2].map((i) => (
                <div key={i} className="bg-[#111115] border border-slate-800 rounded-2xl p-6 space-y-4 animate-slide-up" style={{ animationDelay: `${i * 100}ms` }}>
                  ...
                  <div className="grid grid-cols-3 gap-2 pt-2 border-t border-slate-800/80">
                    <div className="bg-slate-900/50 p-2.5 rounded-xl border border-slate-800/50 space-y-1">
